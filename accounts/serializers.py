...
from .models import File, Batch, Profile, Pdf_Bundels
...
class FileSerializer(serializers.ModelSerializer):
    ...
    batch_Description = serializers.SerializerMethodField('get_desc')
    ...
    class Meta:
        model = File
        fields = ['id','file_path','batch','batch_Description','created_date','user_name','user_id']
...
class BatchFileSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        ...
        image_pdfs = validated_data.pop("pdf_files")
